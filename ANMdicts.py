...
checkNrParamDict = {"weide":0,"wim":0,"jet":0,"duif":1,"schaap":0,"lam":0,"aap":2,"noot":1,"mies":0,"vuur":0,"hok":1,"does":1,"teun":1,"bok":1,"kees":1}
...
"schaap":lambda w : ANMtokens.Schaap(w),"lam":lambda w : ANMtokens.Lam(w),"aap":lambda w,x,y: ANMtokens.Aap(w,x,y),"noot": lambda w,v: ANMtokens.Noot(w,v),"mies": lambda w: ANMtokens.Mies(w),
"vuur": lambda w : ANMtokens.Vuur(w), "does": lambda w, v : ANMtokens.Does(w,v), "hok": lambda w, i : ANMtokens.Hok(w,i), "teun" : lambda w,v : ANMtokens.Teun(w,v), "bok" : lambda w, i : ANMtokens.Bok(w,i),
"kees":lambda w, i : ANMtokens.Kees(w,i)}
...
ANMCompilerTokens.Noot(),"mies" : lambda *args : ANMCompilerTokens.Mies(),"vuur": lambda *args: ANMCompilerTokens.Vuur(),"kees":lambda *args : ANMCompilerTokens.set_scratch_registers(args[1])+ANMCompilerTokens.Kees()} 